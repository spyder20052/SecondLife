...
function Discover() {
    ...
    return (
        <div className="h-full bg-slate-50 flex flex-col">
            {/* Header */}
            <div className="p-4 sm:p-6 pb-4 bg-white rounded-b-[32px] sm:rounded-b-[40px] shadow-sm z-10 sticky top-0">
                ...
                {/* Categories */}
                <div className="flex gap-2 overflow-x-auto pb-2 no-scrollbar -mx-4 px-4 sm:-mx-6 sm:px-6 mask-linear-fade">
                    {categories.map(cat => (
                        <button
                            key={cat}
            ...
            {/* Content */}
            <div className="flex-1 overflow-y-auto p-3 sm:p-4 content-visibility-auto pb-24">
